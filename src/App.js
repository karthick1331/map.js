  ...
  return (
    <div className="App">
      {movie.map((me) => {
        return (
          <div>
            <img src={me.Poster} className="imag" />
            <span className="title">{me.Title}</span>
            <h3 style={{ color: "red" }}>{me.Director}</h3>
            <span className="release">{me.Released}</span>

            <span className="run">{me.Runtime}</span>
            <h5 style={{ color: "orange" }}>{me.Plot}</h5>
          </div>
        );
      })}
    </div>
